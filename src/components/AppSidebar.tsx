...
export default function AppSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 flex flex-col z-50 bg-sidebar"
    style={{ background: 'var(--gradient-sidebar)' }}>
      {/* Logo */}
      <div className="px-6 py-6 flex items-center gap-3 bg-sidebar">
      ...
      {/* Nav */}
      <nav className="flex-1 px-3 mt-2 space-y-1 bg-sidebar">
